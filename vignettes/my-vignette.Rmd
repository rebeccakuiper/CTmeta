...
One can also use the following continuous-time matrices to generate Phi- and SigmaVAR-plots: Drift, the underlying continuous-time lagged effects matrix, and Sigma, the residual covariance matrix of the first-order continuous-time model (also called the diffusion matrix). 
