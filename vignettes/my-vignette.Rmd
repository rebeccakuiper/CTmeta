...
CTmeta was created to implement meta-analyses for lagged effects parameter estimates from discrete-time (DT) models. The method utilized assumes an underlying continuous-time (CT) model, hence the name CTmeta.  Since its creation, many functions have been added including functions to transform, standardize, and plot the time-interval dependent DT lagged effects parameters.
