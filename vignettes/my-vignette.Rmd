...
CTmeta was created to implement meta-analyses of lagged effects parameter estimates from discrete-time (DT) models. The method utilized depends on an underlying continuous-time (CT) model, hence its name CTmeta.  Since its creation, many functions have been added including functions to transform, standardize, and plot the time-interval dependent DT lagged effects parameters.
